/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 661742bd36d1c421253d2bb76afc4600)
// Runtime types generated with workerd@1.20260903.1 2026-08-18 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	MAX_TESTIMONIES: "2000";
	LY_API_ORIGIN: "https://v2.ly.govapi.tw";
	BUILD_SHA: "";
	HEARING: DurableObjectNamespace<import("./src/index").HearingRoom>;
	COORDINATOR: DurableObjectNamespace<import("./src/index").Coordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HearingRoom" | "Coordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_TESTIMONIES" | "LY_API_ORIGIN" | "BUILD_SHA">> {}
}
